...
from model_and_training import load_model
...
problematic_windows = np.array([23, 39, 40, 77, 99, 114, 157])
...
# Class 0 = normality   
walk_windows = np.array(range(0,234))                                                                        
...
def __generate_confusion_matrix(true_labels, predicted_labels, model_type, prefix, path="images/"):
...
def __draw_reconstruction(predicted_data):
    save_path = "Batches-Test-Set-Reconstructed"
...
if __name__ == "__main__":
    ...
    predicted_data, norms, mean_norm_fall, mean_norm_walk = predict_on_test_set(data, model, verbose=False)
